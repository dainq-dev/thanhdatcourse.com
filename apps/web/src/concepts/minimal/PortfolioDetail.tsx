    ...
    <div className={styles.root}>
      <header className={styles.hero}>
        <div className={styles.heroInner}>
          <span className={styles.heroLabel}>{item.category}</span>
          <h1 className={styles.heroTitle}>{item.title}</h1>
          {item.description && (
            <p className={styles.heroTagline}>{item.description}</p>
          )}
          <div className={styles.heroActions}>
            ...
            <Link href="/san-pham" className={styles.heroBtnSecondary}>
              Quay lại danh sách
            </Link>
          </div>
        </div>
