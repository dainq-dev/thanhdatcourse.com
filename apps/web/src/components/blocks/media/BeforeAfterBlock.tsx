...
export function BeforeAfterBlock({
  ...
  return (
    <figure
      ref={containerRef}
      className={`${styles.root} ${isVertical ? styles.vertical : ""}`}
      style={style}
    >
      <div className={styles.after}>
        <img
          src={resolveMediaUrl(d.afterMediaId, "medium")}
          alt={d.afterLabel}
      ...
      <div className={styles.before} style={clipStyle}>
        <img
          src={resolveMediaUrl(d.beforeMediaId, "medium")}
          alt={d.beforeLabel}
          className={styles.img}
        />
      </div>
      <div
        className={`${styles.handle} ${isVertical ? styles.handleV : ""}`}
      ...
      {d.caption && (
        <figcaption className={styles.caption}>{d.caption}</figcaption>
      )}
    </figure>
  );
}
