...
const BORDER_MAP: Record<string, string> = {
  none: "none", thin: "1px solid var(--color-border, #334155)", medium: "2px solid var(--color-border, #334155)", thick: "4px solid var(--color-border, #334155)",
};
const SHADOW_MAP: Record<string, string> = {
  none: "none", sm: "0 1px 3px rgba(0,0,0,0.12)", md: "0 4px 12px rgba(0,0,0,0.15)", lg: "0 10px 30px rgba(0,0,0,0.2)", xl: "0 20px 60px rgba(0,0,0,0.3)",
};

export function ImageBlock({ data }: {
  data: {
    mediaId: string; alt?: string; caption?: string;
    width: string; rounded: string; border: string; shadow: string;
