...
const CTA_THEMES: Record<string, { bg: string; text: string; border: string; btnBg: string; btnText: string }> = {
  blue:    { bg: "#1a73e8", text: "#FFFFFF", border: "none", btnBg: "#FFFFFF", btnText: "#1a73e8" },
  green:   { bg: "#059669", text: "#FFFFFF", border: "none", btnBg: "#FFFFFF", btnText: "#059669" },
  dark:    { bg: "#0F172A", text: "#F8FAFC", border: "none", btnBg: "#3B82F6", btnText: "#FFFFFF" },
  light:   { bg: "#F8FAFC", text: "#0F172A", border: "2px solid #E2E8F0", btnBg: "#0F172A", btnText: "#FFFFFF" },
  red:     { bg: "#DC2626", text: "#FFFFFF", border: "none", btnBg: "#FFFFFF", btnText: "#DC2626" },
  minimal: { bg: "transparent", text: "#0F172A", border: "2px solid #3B82F6", btnBg: "#3B82F6", btnText: "#FFFFFF" },
};

const BTN_STYLES: Record<string, { bg: string; border: string; text: string }> = {
  solid: { bg: "inherit", border: "none", text: "inherit" },
  outline: { bg: "transparent", border: "2px solid currentColor", text: "inherit" },
...
export function CTABlock({
  ...
  const btnColors = data.buttonStyle === "outline"
    ? { background: "transparent", color: theme.text, border: `2px solid ${theme.text}` }
