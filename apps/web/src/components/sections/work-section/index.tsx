  ...
  return (
    <section ref={sectionRef} className={styles.section}>
      ...
      <div className={styles.grid}>
        <a data-work-card href={card1.href} className={`${styles.card} ${styles.left}`}>
        ...
        <a data-work-card href={card2.href} target="_blank" rel="noopener noreferrer" className={`${styles.card} ${styles.right}`}>
          <div className={styles.cardInner}>
