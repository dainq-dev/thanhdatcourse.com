---
description: Build PWAs with Next.js or React. Covers service workers, offline support, web app manifest, install prompts, push notifications, precaching, runtime caching, Workbox, native Next.js PWA, @ducanh2912/next-pwa, configuration, and CRA migration.
---

Root folder: .agents/skills/pwa
