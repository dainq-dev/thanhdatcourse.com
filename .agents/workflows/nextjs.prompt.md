---
description: Expert guidance for Next.js 16.2 App Router: routing, data fetching, caching, Server/Client Components, API routes, middleware, metadata, deployment, optimization, file conventions, debugging, and best practices.
---

Root folder: .agents/skills/nextjs
